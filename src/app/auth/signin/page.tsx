    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-lg">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-blue-900">ContaSaaS</h1>
          <p className="mt-2 text-sm text-gray-600">
            Automacao documental para contabilidade em Portugal
          </p>
        </div>
        ...
        <div className="mt-6 text-center text-xs text-gray-500">
          <p>Ao entrar, aceita os nossos termos de servico e politica de privacidade.</p>
          <p className="mt-1">Dados processados em infraestrutura UE.</p>
        </div>
      </div>
    </div>
  );
