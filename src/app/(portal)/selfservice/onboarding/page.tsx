  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setSuccess(true);
        setTimeout(() => {
          router.push('/selfservice/dashboard');
        }, 2000);
      } else {
    ...
    return (
      <div className="max-w-xl mx-auto py-12">
        <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center">
          <h2 className="text-2xl font-bold text-green-900 mb-2">Empresa Criada!</h2>
          <p className="text-green-700">A redirecionar para o dashboard...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-xl mx-auto space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900">Bem-vindo ao ContaSaaS</h2>
        <p className="text-gray-600 mt-1">Crie a sua empresa para comecar a lancar faturas</p>
      </div>
